...
import java.nio.ByteBuffer
    ...
    /**
	   ...
	   *of structure where many connected elements are
	   *arranged like the branches of tree. Here, there can
	   *be one connection between any two connected modes.
	   *Because any two nodes can have only one mutual connection,
